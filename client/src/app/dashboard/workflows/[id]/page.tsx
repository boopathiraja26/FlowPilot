...
export default function WorkflowBuilderPage() {
  ...
  //
  // IMPORTANT:
  // Clicking a node only changes selectedStepId.
  ...
  async function handleNodeDragStop(
    ...
    try {
      ...
      // Re-fetch only because the order actually changed.
      await fetchWorkflow();
    } catch {
      setActionError(
        "Couldn't save the new step order. Please try again."
      );
    }
  }
                  ...
                  <div className="flex h-full min-h-[200px] items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white">
                    <div className="px-6 text-center">
                      ...
                      <p className="mt-1 text-sm text-gray-400">
                        Select a step on the canvas to
                        edit it.
                      </p>
                    </div>
                  </div>
